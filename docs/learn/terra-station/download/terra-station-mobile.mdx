...
This tutorial walks you through how to install and use the Terra Station mobile app.
...
1. Open the Terra Station mobile app and connect to your wallet.
...
=======
<Admonition type="caution" icon="☢️" title="Keep coins for fees">
>>>>>>> Stashed changes
...
1. Open the Terra Station mobile app and connect to your wallet. Make sure you have Luna in your wallet to stake.
...
Rewards start accruing the moment you stake your Luna. Monitor your rewards in the **STAKE** section of your Terra Station mobile app. Once you have sufficient rewards, follow the steps below to withdraw them.

1. Open the Terra Station mobile app. Connect to a wallet and tap **STAKE** at the bottom of the screen.
...
4. Tap on **Wallet Connect** which will open your Terra Station mobile app.
...
To use Terra Station on your computer, visit the [Terra Station desktop tutorial](./terra-station-desktop.mdx). To learn how to use other Station features, visit the [Terra Station guides](../../../learn/terra-station).
